import torch
from torch.serialization import add_safe_globals # only do this when loading trusted models
...
try:
    ...
    print(f"[FairseqHubert] Warning: Could not add safe globals for Fairseq Dictionary: {e}", flush=True)
